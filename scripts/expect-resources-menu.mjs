...
export function expectResourcesMenu(doc) {
  ...
  assert.deepEqual(destinations(replacement), [...destinations(panel), "/online-therapy-texas/"].sort(), "Every existing Resources destination plus the approved telehealth link must be retained");
